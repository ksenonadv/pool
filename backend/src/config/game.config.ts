export const POOL_GAME_MIN_PLAYERS = 2;
...
export const BALL_SPACING = BALL_RADIUS * 1.5;
...
export const SOLID_BALLS = [1, 2, 3, 4, 5, 7, 13];
export const STRIPED_BALLS = [9, 10, 11, 12, 14, 15];